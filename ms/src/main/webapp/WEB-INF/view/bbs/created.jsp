...
<form name="boardForm" method="post">
  ...
  <tr align="left" height="40" style="border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc;"> 
      ...
      <td style="padding-left:10px;"> 
        <input type="text" name="subject" maxlength="100" class="boxTF" style="width: 95%;" value="${resultMap.subject}">
      </td>
  </tr>
  ...
  <tr align="left" height="40" style="border-bottom: 1px solid #cccccc;"> 
      ...
      <td style="padding-left:10px;"> 
        <input type="text" name="name" size="35" maxlength="20" class="boxTF" value="${resultMap.name}">
      </td>
  </tr>
  ...
  <tr align="left" style="border-bottom: 1px solid #cccccc;"> 
      ...
      <td valign="top" style="padding:5px 0px 5px 10px;"> 
        <textarea name="content" rows="12" class="boxTA" style="width: 95%;">${resultMap.content}</textarea>
      </td>
  </tr>
     ...
     <tr height="45"> 
      <td align="center" >
         <c:if test="${mode=='update' }">
             <input type="hidden" name="num" value="${resultMap.num}">
